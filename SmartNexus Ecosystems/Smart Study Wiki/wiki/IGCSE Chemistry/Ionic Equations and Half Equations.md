...
**Summary**: Ionic equations show only the particles that actually change in a reaction. Spectator ions are omitted. Half equations show electron transfer in oxidation and reduction separately. Both are cross-cutting skills tested across ALL topics.
**Tags**: #igcse #chemistry #equations #ionic #redox #cross-cutting
**Created**: 2026-07-14
...
**Net ionic**: H⁺(aq) + OH⁻(aq) → H₂O(l) ← Na⁺ and Cl⁻ are spectator ions — they don't change
...
- **BBC Bitesize GCSE Chemistry** — Ionic equations and half equations, BBC (free educational resource)
- **OpenStax Chemistry 2e** — Writing ionic equations and redox half-reactions, Rice University (free, CC BY 4.0)
- **Cambridge IGCSE Chemistry 0620** — Syllabus sections on ionic equations and redox, Cambridge Assessment International Education
- **CK-12 Chemistry for High School** — Ionic equations and net ionic equations, CK-12 Foundation (free, CC BY-NC 3.0)
