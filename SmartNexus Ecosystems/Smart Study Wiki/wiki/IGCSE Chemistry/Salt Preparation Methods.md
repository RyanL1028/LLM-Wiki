...
**Summary**: Three methods for preparing salts: (1) excess metal/insoluble base + acid, (2) titration for soluble Group 1/ammonium salts, (3) precipitation for insoluble salts. Choosing the right method depends on the salt's solubility.
**Tags**: #igcse #chemistry #salts #practical #preparation
**Created**: 2026-07-14
...
- **BBC Bitesize GCSE Chemistry** — [Salts and preparation methods](https://www.bbc.co.uk/bitesize/guides/z84w7p3/revision/1), BBC (free educational resource)
- **OpenStax Chemistry 2e** — [Precipitation and Dissolution](https://openstax.org/books/chemistry-2e/pages/15-1-precipitation-and-dissolution), Rice University (free, CC BY 4.0)
- **Cambridge IGCSE Chemistry 0620** — Syllabus topic 7 (Acids, Bases and Salts), Cambridge Assessment International Education
- **CK-12 Chemistry for High School** — [Acids and Bases](https://www.ck12.org/book/CK-12-Chemistry-Intermediate/), CK-12 Foundation (free, CC BY-NC 3.0)
...
|---|---|
| "You should evaporate to dryness to get the salt" | Evaporation to dryness gives an impure powder, not crystals. Heat only to the crystallisation point, then cool slowly for pure crystals. |
| "Wash crystals with hot water to clean them" | Hot water dissolves more of the salt, losing product. Always wash with **cold** distilled water. |
| "Any metal can be used in Method A" | Group 1 metals react too violently with acids and cannot be used safely. |
| "The indicator stays in the final salt from titration" | The titration is repeated without indicator using the exact volume found, so the salt is pure. |
| "Precipitation gives you a liquid product" | The insoluble salt is a solid precipitate that can be collected by filtration. |
| "Crystals don't need to be dried before weighing" | Wet crystals weigh more due to water on the surface, giving an inaccurate mass. |
