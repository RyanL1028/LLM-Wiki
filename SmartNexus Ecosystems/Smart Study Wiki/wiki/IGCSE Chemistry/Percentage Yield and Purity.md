...
**Summary**: Percentage yield compares the actual mass of product obtained to the theoretical mass predicted from stoichiometry. Percentage purity measures how much of a sample is the desired substance. Both are key calculation skills for IGCSE Chemistry.
**Tags**: #igcse #chemistry #calculations #yield #purity #stoichiometry
**Created**: 2026-07-14
...
- **BBC Bitesize GCSE Chemistry** — Percentage yield and atom economy, BBC (free educational resource)
- **OpenStax Chemistry 2e** — Stoichiometry: yield and limiting reagents, Rice University (free, CC BY 4.0)
- **Cambridge IGCSE Chemistry 0620** — Syllabus section on percentage yield and purity calculations, Cambridge Assessment International Education
- **CK-12 Chemistry for High School** — Percentage yield and purity calculations, CK-12 Foundation (free, CC BY-NC 3.0)
